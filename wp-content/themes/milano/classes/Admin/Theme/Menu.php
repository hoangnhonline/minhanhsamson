...
class Admin_Theme_Menu
{
	...
	public function getMenuPageList($menu_slug = '')
	{
		return array(
			...
			new Admin_Theme_Item_BGSlideshow($menu_slug),
			new Admin_Theme_Item_Sounds($menu_slug),
			new Admin_Theme_Item_MainMenu($menu_slug),
			new Admin_Theme_Item_Header($menu_slug),
			new Admin_Theme_Item_Blog($menu_slug),
			new Admin_Theme_Item_Portfolio($menu_slug),
	...
	{
			wp_enqueue_style('th-admin-css', get_template_directory_uri() .'/css/admin.css','','1.0.0', 'all');
	}
	...
	{
		wp_enqueue_script('th-colorpicker', get_template_directory_uri() .'/js/backend/mColorPicker/javascripts/mColorPicker.js', array('jquery'), '1.0.0');
		wp_enqueue_script('th-uniform', get_template_directory_uri() .'/js/backend/uniform/jquery.uniform.min.js', array('jquery'), '1.0.0');
		wp_enqueue_script('th-ibutton', get_template_directory_uri() .'/js/backend/switcher/lib/jquery.ibutton.js', array('jquery'), '1.0.0');
		wp_enqueue_script('th-qtip', get_template_directory_uri() .'/js/backend/qtip/jquery.qtip.pack.js', array('jquery'), '1.0.0');
		wp_enqueue_script('admin-custom', get_template_directory_uri() .'/js/backend/custom.js', array('jquery'), '1.0.0');
	...
	{
		wp_register_script('th-admin', get_template_directory_uri() .'/js/backend/admin.js', array('jquery'), '1.0.0');
	}
