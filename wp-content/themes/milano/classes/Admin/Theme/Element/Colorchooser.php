	...
	public function render()
	{
		...
		ob_start();
			...
			<div class="textfield_wrap">
				<input style="width:187px;clear:both" name="<?php echo $this->id; ?>" id="<?php echo $this->id; ?>" type="color" data-hex="true" value="<?php if ( get_option( $this->id ) != "") { echo get_option( $this->id ); } else { echo $this->std; } ?>" />
			</div>
			<?php
