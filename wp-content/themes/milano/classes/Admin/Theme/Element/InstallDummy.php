...
class Admin_Theme_Element_InstallDummy extends Admin_Theme_Menu_Element
{
	...
	public function render()
	{
		...
		if ($this->isDummyInstalled(SHORTNAME.'_dummy_install')): ?>
			<div id="message" class="updated fade" style="width:450px;margin:15px 30px !important"><p><strong>Dummy content already installed.</strong></p></div>
		<?php endif; ?>
		<input name="install_dummy" type="submit" value=" Install dummy content " class="ml_install_dummy" /> 
		<br>
		<br>
