...
abstract class Admin_Theme_Menu_Element
{
	...
	public function setElementListClass($class)
	{
		$this->option['listClass'] = $class;
		return $this;
	}
	...
	protected function getElementHeader()
	{
		ob_start();
		?>
		<li class="<?php echo $this->listClass ?> <?php echo ($this->group) ? $this->group.' hidden' : '';?>">
