...
<title><?php _e('Contact form','milano'); ?></title>
...
<style>
	...
	.right { float: right; }
	.fb-send-text { margin-top:10px }
	.fb-send-text label { float: left; padding-right: 10px; padding-left: 25px;}
	.fb-send-text input { float: left; width: 180px; }
</style>
</head>

<body  onload="init();">
	<div id="media-upload-header">
		<div id="fb-success" class="fb-success" style="display: none;"><?php _e('Your new field was saved successfully','milano'); ?></div>

	</div>
	<div class="fb-right">
	
		<div id="fb-add-field" style="display: none;">
			<h3><?php _e('Edit this new field','milano'); ?></h3>
			
			<label for="fb-new-label"><?php _e('Label','milano'); ?></label>
			<input type="text" id="fb-new-label" value="<?php _e('New field','milano'); ?>" />
			
			<label for="fb-new-label"><?php _e('Field type','milano'); ?></label>
			<select id="fb-new-type">
				<option value="checkbox"><?php _e('Checkbox','milano'); ?></option>
				<option value="select"><?php _e('Drop down','milano'); ?></option>
				<option value="email"><?php _e('Email','milano'); ?></option>
				<option value="name"><?php _e('Name','milano'); ?></option>
				<option value="radio"><?php _e('Radio','milano'); ?></option>
				<option value="text" selected="selected"><?php _e('Text','milano'); ?></option>
				<option value="textarea"><?php _e('Textarea','milano'); ?></option>
				<option value="url"><?php _e('Website','milano'); ?></option>
			</select>
			<div class="clear"></div>
			
			<div id="fb-options" style="display: none;">
				<div id="fb-new-options">
					<label for="fb-option0"><?php _e('Options','milano'); ?></label>
					<input type="text" id="fb-option0" optionid="0" value="<?php _e('First option','milano'); ?>" class="fb-options" />
				</div>
				<div id="fb-add-option" class="fb-add-option">
					<a href="#" id="fb-another-option"><?php _e('Add another option','milano'); ?></a>
				</div>
			</div>
			...
			<div class="fb-required">
				...
				<label for="fb-new-label" class="fb-radio-label"><?php _e('Required?','milano'); ?></label>
				<div class="clear"></div>
			</div>
			<div id="fb-reply" style="display: none;">
				<label for="fb-new-label"></label>
				<input type="checkbox" id="fb-new-reply" />
				<label for="fb-new-label" class="fb-radio-label"><?php _e('Use for reply?','milano'); ?></label>
				<div class="clear"></div>
			</div>
			
			<input type="hidden" id="fb-field-id" />
			<input type="submit" class="button" value="<?php _e('Save this field','milano'); ?>" id="fb-save-field" name="save">
		</div>
	</div>
	<form id="fb-preview">
		<div id="fb-add-field" class="fb-container" style="float:left">
			<h1><?php _e("Here's what your form will look like","milano"); ?></h1>
			<div id="sortable" class="fb-form-case">
				
				<div id="fb-extra-fields" class="fb-extra-fields"></div>
				
				<a href="#" id="fb-new-field" class="fb-add-field"><?php _e('Add a new field','milano'); ?></a>
			</div>
			<div class="fb-send-text">
					<label fieldid="sendbutton" for="fb-sendbutton">
						<span class="label-text">Send button text</span>
					</label>
					<input type="text" id="fb-sendbutton" value="">
			</div>
			<input type="submit" class="button-primary" tabindex="4" value="<?php _e('Add this form to my post','milano'); ?>" id="fb-save-form" name="save">
		</div>
		<div id="fb-email-settings" class="fb-container" style="float: left;">
			<h1><?php _e('Email settings','milano'); ?></h1>
			<div class="fb-form-case fb-settings">
				<label for="fb-fieldname"><?php _e('Enter your email address','milano'); ?></label>
				<input type="text" id="fb-field-my-email" style="background: #FFF !important;" />

				<label for="fb-fieldemail" style="margin-top: 14px;"><?php _e('What should the subject line be?','milano'); ?></label>
