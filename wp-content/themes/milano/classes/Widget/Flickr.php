...
HTML;
	...
	function form( $instance ) {
		...
		// Defaults
		$defaults = array( 'title' => __( 'Flickr', 'milano' ), 'number' => '4');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>">
				<?php _e( 'Number of photos:', 'milano' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'user' ); ?>">
				<?php _e( 'Flickr ID', 'milano' ); ?> (<a href="http://www.idgettr.com" target="_blank">idGettr</a>) :
			</label>
