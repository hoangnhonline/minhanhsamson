...
if ( ! function_exists( 'wpml_content_languages' ) ) {
	function wpml_content_languages($args = '')
	{
		parse_str($args);
		if (function_exists('icl_get_languages'))
		{
			...
			{
				echo isset($before) ? $before : __('This post is also available in: ', 'milano');
 ...
 * @param string $anchor
 * @param bool $echoit - flag to return or echo result
 * @return string
 */
...
if ( ! function_exists( 'wpml_languages_selector' ) ) {
...
if ( ! function_exists( 'wpml_default_link' ) ) {
